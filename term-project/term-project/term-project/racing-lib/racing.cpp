...
//модуль гонок
#include "include/racing.h"

//транспорт
#include "include/transport_camel.h"
#include "include/transport_high_speed_camel.h"
#include "include/transport_centaur.h"
#include "include/transport_crosscountry_boots.h"
#include "include/transport_eagle.h"
#include "include/transport_broom.h"
#include "include/transport_magic_carpet.h"

Racing::Racing(race_type new_race_type, int new_distance): my_race_type(new_race_type), race_distance(new_distance)
{
...
void Racing::racing_init() //инициализация гонки - заполнение массива участников объектами класса Transport
{
	try
	{
...
bool Racing::get_racing_ready() //готов ли объект racing  к использованию
{
	return racing_ready;
}
